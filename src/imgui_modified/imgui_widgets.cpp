...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    const bool highlighted = (flags & ImGuiButtonFlags_NoHighlight ? 0 : hovered);

    // Render
    const ImU32 col = GetColorU32((held && highlighted) ? ImGuiCol_ButtonActive : highlighted ? ImGuiCol_ButtonHovered : ImGuiCol_Button);
